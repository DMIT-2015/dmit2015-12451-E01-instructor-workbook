...
public class AutomaticTimersBean {	// Also known as Calendar-Based Timers
	...
	public void dmit2015SectionOE01ClassNotifiation(Timer timer) {
	 ...
	 @Schedules({
	 	@Schedule(second = "0", minute ="40", hour = "20", dayOfWeek = "Mon,Wed", month = "Sep-Dec", year = "2025", info ="DMIT2015-E01 In Person Meeting", persistent = false),
	...
	public void dmit2015SectionE01ClassNotifiation(Timer timer) {
		 ...
		 logger.info("Started batch job " + jobId);
		 sendEmail(timer);
	}
