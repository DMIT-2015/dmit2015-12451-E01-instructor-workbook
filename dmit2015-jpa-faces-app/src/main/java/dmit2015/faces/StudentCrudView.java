...
//                String base64EncodedImageString = Base64.getEncoder().encodeToString(uploadedImageFile.getContent());
//                // Create a Data URI for the image
//                String imageDataUri = String.format("data:image/%s;base64,%s",
//                        uploadedImageFile.getContentType(),
